...
public class BlackBoxCore extends ClientConfiguration {
    ...
    public void doAttachBaseContext(Context context,
        ...
        // Re-run WebView data directory setup now that context is available
        // (the static init attempt may have been skipped due to null context)
        SocialMediaAppCrashPrevention.ensureWebViewDataDir();
